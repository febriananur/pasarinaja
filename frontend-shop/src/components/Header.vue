<template>
    <header class="section-header">
        <section class="header-main border-bottom" style="color:#DC143C; background-color:#DC143C;">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-md-3 col-7">
                        <router-link :to="{name: 'home'}" class="text-decoration-none" data-abc="true">
                            <span class="logo"><i class="fas fa-carrot"></i> PASARIN.AJA </span>
                        </router-link>
                    </div>
                   <div class="col-md-5 d-none d-md-block">
                        
                            <div class="input-group w-100">
                                <input type="text" v-model="keywords" class="form-control search-form" style="width:55%;border: 1px solid #ffffff" placeholder="mau beli apa hari ini ?">
                                <div class="input-group-append">
                                   <router-link :to="{name: 'search'}"><button @click="search" class="btn search-button" type="submit"><i class="fa fa-search"></i>
	                                </button></router-link>
                                </div>
                            </div>
                    ...
                    <div class="col-md-4 col-5">
                        <div class="d-flex justify-content-end">
                            ...
                            <div class="cart-header">
                                <router-link :to="{name: 'cart'}" class="btn search-button btn-md" style="color: #ffffff;background-color: #DC143C;border-color: #ffffff;"><i class="fa fa-shopping-cart"></i> {{ cartCount }} | Rp. {{ moneyFormat(cartTotal) }} </router-link>
                            </div>
